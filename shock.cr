...
def writeToFile_Shock(module_information_list : Array(ModuleInformation), filename = "shock.json")
  json_output = "[" +
...
def shock(filename = "shock.json")
  ...
  writeToFile_Shock(module_information_list, filename)
end
...
def main()
  remap_ntdll = false
  json_name = "shock.json"

  option_parser = OptionParser.new do |parser|
    parser.banner = "Usage: shock [options]"
