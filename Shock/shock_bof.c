...
char* get_json(ModuleInformation* module_list, int module_counter){
    ...
    for (int i = 0; i < module_counter; i++) {
        ...
        char* json_part_2 = create_string_with_var("\"field1\": \"", module_list[i].full_dll_path, "\", ");
        char* json_part_3 = create_string_with_var("\"field2\": \"", base_buffer, "\", ");
        char* json_part_4 = create_string_with_var("\"field3\": \"", size_buffer, "\"}");
        char* json_entry = concatenate_strings(concatenate_strings(json_part_1, json_part_2), concatenate_strings(json_part_3, json_part_4));
